...
Wolf.Input = (function() {
    ...
    function init() {
        var game = $("#game"),
          ...
          rsc = $("#game .renderer .right-side-controls");
          lsc = $("#game .renderer .left-side-controls");
          ...
          $(window).on("navigate", function (event, data) {
            ...
            .bind('touchstart',function(e){
              ...
              keys[27] = true;
              if (bindings[27]) {
                  for (var i=0,n=bindings[27].length;i<n;i++) {
                      bindings[27][i](e);
                  }
              }
            })
            ...
            .bind('touchstart',function(e){
              ...
              keys[13] = true;
              if (bindings[13]) {
                  for (var i=0,n=bindings[13].length;i<n;i++) {
                      bindings[13][i](e);
                  }
              }
            })
        ...
        if (!keys) {
            ...
            $("#game")
                ...
                .bind('touchstart',function(e){
                  ...
                  keys[16] = true;
                  if (bindings[16]) {
                      for (var i=0,n=bindings[16].length;i<n;i++) {
                          bindings[16][i](e);
                      }
                  }
                })
                ...
                .bind('touchstart',function(e){
                  ...
                  keys[90] = true;
                  if (bindings[90]) {
                      for (var i=0,n=bindings[90].length;i<n;i++) {
                          bindings[90][i](e);
                      }
                  }
                })
